"""Frozen semantic-v2.1 compatibility implementation for Luna canary v1.

Source snapshot: commit f02c72c. This module exists only to replay the immutable
v1 artifact contract; active semantic work belongs in
``profile_bio_semantic_v2`` and must never be backported here.
