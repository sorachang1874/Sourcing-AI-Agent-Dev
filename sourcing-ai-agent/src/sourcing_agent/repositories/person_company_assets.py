...
PERSON_ASSETS = TableDescriptor(
    ...
    columns=(
        ...
        Column("source_url"),
        Column("fetched_at"),
        Column("visibility_scope", default="internal", read_default="internal"),
        Column("status", default="available", read_default="available"),
...
PERSON_EVIDENCE = TableDescriptor(
    ...
    columns=(
        ...
        Column("status", default="observed", read_default="observed"),
        Column("metadata_json", Kind.JSON, field="metadata"),
        Column("created_at"),
        Column("updated_at"),
    ),
...
PERSON_ASSERTIONS = TableDescriptor(
    ...
    columns=(
        ...
        Column("value"),
        Column("normalized_value"),
        Column("authority", default="provider_observed", read_default="provider_observed"),
        Column("verification_status", default="needs_review", read_default="needs_review"),
