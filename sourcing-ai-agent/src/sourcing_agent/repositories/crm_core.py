...
CRM_RECORDS = TableDescriptor(
    ...
    columns=(
        ...
        Column("lifecycle_status", default="active", read_default="active"),
        Column("visibility_status", default="normal", read_default="normal"),
...
CRM_TASKS = TableDescriptor(
    ...
    columns=(
        ...
        Column("title"),
        Column("description"),
        Column("status", default="open", read_default="open"),
        Column("priority", default="normal", read_default="normal"),
        Column("due_at"),
        Column("completed_at"),
