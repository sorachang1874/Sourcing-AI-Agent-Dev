...
const mockCandidates: Candidate[] = [
  {
    ...
    confidence: "high",
    outreachLayer: 0,
    matchedKeywords: ["multimodal", "video generation", "Veo 3"],
  ...
  },
  {
    ...
    confidence: "medium",
    outreachLayer: 1,
    matchedKeywords: ["multimodal", "infra", "Nano Banana"],
  ...
  },
  {
    ...
    outreachLayer: 2,
    matchedKeywords: ["vision-language", "multimodal"],
...
export const mockDashboard: DashboardData = {
  ...
  targetCompany: "Google DeepMind",
  intentKeywords: ["multimodal", "video generation", "Veo 3", "Nano Banana"],
  resultMode: "ranked_results",
  resultModeLabel: "检索排序结果",
  rankedCandidateCount: mockCandidates.length,
  assetPopulationCount: mockCandidates.length,
  totalCandidates: mockCandidates.length,
  totalEvidence: mockCandidates.flatMap((candidate) => candidate.evidence).length,
  manualReviewCount: 2,
  layers: [
    { id: "layer_0", label: "Layer 0", count: 1 },
