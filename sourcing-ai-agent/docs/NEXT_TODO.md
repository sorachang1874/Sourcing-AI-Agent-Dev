...
- [x] ② 域退役进行中（入口文档 `docs/TRACK_B_REPOSITORY_MIGRATION_HANDBOOK.md`）：②.0 linkedin_profile_registry（2026-07-02）+ ②.1 criteria/confidence（2026-07-06）已完成并于 2026-07-09 提交（`d5109f1`，storage.py 19,187 → 15,091 行）。**下一批：②.2 manual_review**（handbook §3 顺序；§4 协议 v2 + 2026-07-09 step 7 异步评审）。
