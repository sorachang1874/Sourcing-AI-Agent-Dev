...
- [TRACK_D_D3C2C_ACTIVITY_TERMINAL_EVIDENCE_CHARACTERIZATION.md](TRACK_D_D3C2C_ACTIVITY_TERMINAL_EVIDENCE_CHARACTERIZATION.md) — D3c2c characterization-only mechanical baseline（ActivityRun/Attempt/event=`20/22/17` columns；upsert/append=`30/22/62` calls；ActivityRun raw get=`26=25 external+1 internal`，其中新增 test-double fallback 而 production list 用 batch；Attempt get raw/external/internal=`2/1/1`；unique event INSERT + direct cancel UPDATE owners；ratified exact future intent/response/failure/quarantine/terminal-registry named surfaces absent，dispatch-exposure owner/name=`unratified/undetermined`、不作 zero claim；两次 review artifact 均因 Desktop memory annotation invalid，lexical-zero、完整 Migration-A order 与 exact non-closure advisory 已 fixed-forward，oracle=`8 passed`、fresh highest-effort retry pending；R-019/R-023/R-027/R-029/OB gates 与 served=0 不变）。
