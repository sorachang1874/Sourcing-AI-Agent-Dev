...
- [TRACK_D_D3C2C_ACTIVITY_TERMINAL_EVIDENCE_CHARACTERIZATION.md](TRACK_D_D3C2C_ACTIVITY_TERMINAL_EVIDENCE_CHARACTERIZATION.md) — D3c2c characterization-only mechanical baseline（ActivityRun/Attempt/event=`20/22/17` columns；upsert/append=`30/22/62` calls；Attempt get raw/external/internal=`2/1/1`；unique event INSERT + direct cancel UPDATE owners；future intent/response/failure/quarantine/terminal-registry/dispatch-exposure physical owners=0；下一批需 owner-ratified dormant ActivityRun+Attempt DDL，R-019/R-023/R-027/R-029/OB gates 与 served=0 不变）。
