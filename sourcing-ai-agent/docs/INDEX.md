...
- [INDEPENDENT_REVIEWER_HOME_PROPOSAL.md](INDEPENDENT_REVIEWER_HOME_PROPOSAL.md) — reviewer 专属 CODEX_HOME 提案（2026-07-13，可行性已实证；修复 Desktop 自动切配置/CLI 双装漂移/runner 多线程代差三个实测故障根因；owner 待裁决）。
