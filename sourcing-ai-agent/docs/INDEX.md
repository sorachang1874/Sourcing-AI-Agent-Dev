...
- [TRACK_D_D1C_REQUEST_SCHEMA_PIN_FOUNDATION_IMPLEMENTATION.md](TRACK_D_D1C_REQUEST_SCHEMA_PIN_FOUNDATION_IMPLEMENTATION.md) — D1c 非 live request-schema pin 地基（D0 ToolSpec 共享 validator/digest、owner-bound target、AgentAction→OperationRun physical copy/verify、R-029 schema-less bridge；15 个 production actions 仍 schema-less、served=0；implementation = enclosing commit，exact hash 由 pinned review request 绑定）。
