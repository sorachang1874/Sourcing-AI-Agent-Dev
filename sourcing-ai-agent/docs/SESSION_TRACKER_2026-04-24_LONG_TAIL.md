...
- 2026-04-24: Production runtime now requires PG by runtime contract, not only by startup script. This originally had an explicit SQLite emergency escape hatch; the 2026-04-25 storage-surface closeout removed that escape hatch for production runtime.
